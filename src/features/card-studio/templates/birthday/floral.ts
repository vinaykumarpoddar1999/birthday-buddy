...
export const floralTemplate: CardTemplate = {
  ...
  layout: 'portrait',
  elements: [
    { id: 'fl-1', type: 'sticker', content: '🌸', x: 18, y: 18, width: 30, height: 30, rotation: -12, opacity: 0.7, zIndex: 1, visible: true, fontSize: 22 },
    { id: 'fl-2', type: 'sticker', content: '🌹', x: 288, y: 20, width: 30, height: 30, rotation: 10, opacity: 0.7, zIndex: 1, visible: true, fontSize: 22 },
    ...
    { id: 'fl-5', type: 'sticker', content: '💐', x: 142, y: 245, width: 56, height: 56, rotation: 0, opacity: 1, zIndex: 2, visible: true, fontSize: 48 },
    ...
    { id: 'fl-8', type: 'sticker', content: '🌷', x: 155, y: 445, width: 25, height: 25, rotation: 0, opacity: 0.5, zIndex: 1, visible: true, fontSize: 18 },
  ],
};
