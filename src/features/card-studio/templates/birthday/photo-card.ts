...
export const photoCardTemplate: CardTemplate = {
  ...
  decorations: ['icon:camera', 'icon:heart', 'icon:sparkles'],
  layout: 'portrait',
  elements: [
    { id: 'pc-1', type: 'sticker', content: 'icon:sparkles', x: 20, y: 18, width: 24, height: 24, rotation: 0, opacity: 0.5, zIndex: 1, visible: true, fontSize: 18 },
    ...
    { id: 'pc-3', type: 'image', x: 80, y: 85, width: 180, height: 180, rotation: 0, opacity: 1, zIndex: 2, visible: true, isPlaceholder: true, placeholderKey: 'photo', backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 90, borderWidth: 3, borderColor: 'rgba(255,255,255,0.4)', content: 'icon:camera', fontSize: 44 },
    ...
    { id: 'pc-7', type: 'sticker', content: 'icon:heart', x: 158, y: 448, width: 24, height: 24, rotation: 0, opacity: 0.4, zIndex: 1, visible: true, fontSize: 18 },
  ],
};
