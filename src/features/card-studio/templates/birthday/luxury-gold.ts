...
export const luxuryGoldTemplate: CardTemplate = {
  ...
  layout: 'portrait',
  elements: [
    { id: 'lg-1', type: 'sticker', content: '✨', x: 20, y: 20, width: 30, height: 30, rotation: 0, opacity: 0.5, zIndex: 1, visible: true, fontSize: 20 },
    { id: 'lg-2', type: 'sticker', content: '👑', x: 285, y: 22, width: 30, height: 30, rotation: 0, opacity: 0.6, zIndex: 1, visible: true, fontSize: 22 },
    ...
    { id: 'lg-5', type: 'sticker', content: '🎂', x: 142, y: 245, width: 56, height: 56, rotation: 0, opacity: 1, zIndex: 2, visible: true, fontSize: 48 },
    ...
    { id: 'lg-8', type: 'sticker', content: '⭐', x: 155, y: 445, width: 25, height: 25, rotation: 0, opacity: 0.4, zIndex: 1, visible: true, fontSize: 18 },
  ],
};
