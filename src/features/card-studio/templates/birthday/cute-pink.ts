...
export const cutePinkTemplate: CardTemplate = {
  ...
  decorations: ['icon:gift', 'icon:heart', 'icon:cake'],
  layout: 'portrait',
  elements: [
    { id: 'cp-1', type: 'sticker', content: 'icon:gift', x: 22, y: 20, width: 28, height: 28, rotation: -10, opacity: 0.7, zIndex: 1, visible: true, fontSize: 20 },
    { id: 'cp-2', type: 'sticker', content: 'icon:heart', x: 288, y: 22, width: 28, height: 28, rotation: 8, opacity: 0.7, zIndex: 1, visible: true, fontSize: 20 },
    ...
    { id: 'cp-5', type: 'sticker', content: 'icon:cake', x: 142, y: 240, width: 56, height: 56, rotation: 0, opacity: 1, zIndex: 2, visible: true, fontSize: 48 },
    ...
    { id: 'cp-8', type: 'sticker', content: 'icon:flower', x: 155, y: 445, width: 25, height: 25, rotation: 0, opacity: 0.5, zIndex: 1, visible: true, fontSize: 18 },
  ],
};
