...
export const neonPartyTemplate: CardTemplate = {
  ...
  decorations: ['icon:party-popper', 'icon:sparkles', 'icon:zap'],
  layout: 'portrait',
  elements: [
    { id: 'np-1', type: 'sticker', content: 'icon:party-popper', x: 20, y: 18, width: 28, height: 28, rotation: -15, opacity: 0.8, zIndex: 1, visible: true, fontSize: 22 },
    { id: 'np-2', type: 'sticker', content: 'icon:sparkles', x: 288, y: 18, width: 28, height: 28, rotation: 12, opacity: 0.8, zIndex: 1, visible: true, fontSize: 22 },
    ...
    { id: 'np-6', type: 'sticker', content: 'icon:zap', x: 148, y: 245, width: 44, height: 44, rotation: 0, opacity: 0.9, zIndex: 2, visible: true, fontSize: 36 },
