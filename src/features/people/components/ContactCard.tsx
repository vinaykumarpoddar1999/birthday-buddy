    ...
    <View className="bg-surface rounded-2xl border border-border px-4 py-3.5 mb-3 shadow-sm">
      <View className="flex-row items-center gap-3">
        ...
        <View className="flex-row items-center gap-1">
          <Pressable onPress={handleCall} className="h-9 w-9 rounded-full bg-primary/10 items-center justify-center" accessibilityRole="button" accessibilityLabel="Call">
            <Phone size={16} color="#7C3AED" />
          </Pressable>
          <Pressable onPress={handleMessage} className="h-9 w-9 rounded-full bg-primary/10 items-center justify-center" accessibilityRole="button" accessibilityLabel="Message">
            <MessageCircle size={16} color="#7C3AED" />
          </Pressable>
          <Pressable onPress={handleMore} className="h-9 w-9 rounded-full bg-border/30 items-center justify-center" accessibilityRole="button" accessibilityLabel="More options">
